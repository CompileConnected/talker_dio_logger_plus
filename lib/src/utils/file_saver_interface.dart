...
/// A no-op file saver that does nothing.
///
/// Use this when you want to disable file saving/sharing functionality
/// without adding the file saving dependencies.
class NoOpFileSaver implements FileSaverInterface {
  const NoOpFileSaver();
  ...
  @override
  Uint8List? getBytes(dynamic data) => null;
}
